...
public typealias ATDialogAction = () -> Void
...
@objc public extension UIViewController {
     ...
     */
    class func showOnTopOfStatusBar(_ notificationView: UIView, duration: TimeInterval, animated: Bool = true, message: String = "") {
        SwiftOverlays.showOnTopOfStatusBar(notificationView, duration: duration, animated: animated, message: message)
    }
...
open class SwiftOverlays: NSObject {
    ...
    static let bannerDissapearAnimationDuration = 0.2
    ...
    open class func showOnTopOfStatusBar(_ notificationView: UIView, duration: TimeInterval, animated: Bool = true, message: String) {
        if bannerWindow == nil {
